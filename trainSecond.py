...
train_dst = dataset.MPIIGazesDatasetInference(path = r"D:\MPIIGaze\inference.bin")
print(len(train_dst))
val_dst = dataset.MPIIGazesDatasetInference(path = r"D:\MPIIGaze\inference.bin", is_train=False)
...
model.load_state_dict(torch.load(r"D:/MPIIGaze/gaze_vector_finder.pth"))
...
torch.save(model.state_dict(), "D:/MPIIGaze/gaze_vector_finder_BIGGER.pth")
